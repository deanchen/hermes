...
(function() {
  var CLIENTS, COMMIT, MAX_COMPLETE, MIN_COMPLETE, PIPELINE, STOP_WORDS, args, clients, commitLine, completed, fill_pipeline, finished_processing, fs, hashKeyFields, hashSet, i, index, lazy, path, prefix, readLines, redis, sent, startTime, stats, stream, termClient, totalWorkers, uprefixes, workerIndex;
